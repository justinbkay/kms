class CreateMinorDirectReferrals < ActiveRecord::Migration
  def change
    create_table :minor_direct_referrals do |t|
    ...
    add_index(:minor_direct_referrals, [:user_id])
    add_index(:minor_direct_referrals, [:student_id])
